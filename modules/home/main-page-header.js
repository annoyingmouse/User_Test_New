export default {
  template: `
    <div class="page-header">
      ...
      <p>We're doing some testing on how easy it is for our users to input the members of a family and their details so we'd be really grateful if you could imagine you are Dr. 08 08 with a <abbr title="Date of Birth">DOB</abbr> of 08/08/0808 (you're looking really good for your age). Further, your family is like this:</p>
      <ul>
